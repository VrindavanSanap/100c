...
int main()
{
    ...
    cJSON_ArrayForEach(book, books)
    {
        ...
        char* author = cJSON_GetObjectItemCaseSensitive(book, "author")->valuestring;
        int published_year = cJSON_GetObjectItemCaseSensitive(book, "published_year")->valueint;
        ...
        char* language = cJSON_GetObjectItemCaseSensitive(book, "language")->valuestring;
        char* publisher = cJSON_GetObjectItemCaseSensitive(book, "publisher")->valuestring;
