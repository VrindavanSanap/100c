...
int main()
{
    ...
    for (int i = 0; i < total_questions; i++)
    {
        ...
        char* question = cJSON_GetObjectItemCaseSensitive(question_obj, "question")->valuestring;
        char* distractor1
            = cJSON_GetObjectItemCaseSensitive(question_obj, "distractor1")->valuestring;
        char* distractor2
            = cJSON_GetObjectItemCaseSensitive(question_obj, "distractor2")->valuestring;
        char* distractor3
            = cJSON_GetObjectItemCaseSensitive(question_obj, "distractor3")->valuestring;
        char* correct_answer
            = cJSON_GetObjectItemCaseSensitive(question_obj, "correct_answer")->valuestring;
        char* support = cJSON_GetObjectItemCaseSensitive(question_obj, "support")->valuestring;
