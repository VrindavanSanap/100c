...
long long get_profit_paise(long long buy_price,long long sell_price, long long num_units){
...
char* get_profit(const char* buy_price, const char* sell_price, long long num_units){

  long long profit_paise = get_profit_paise(parse_rupees_to_paise(buy_price), parse_rupees_to_paise(sell_price), num_units);
