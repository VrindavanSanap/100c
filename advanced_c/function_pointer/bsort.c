...
void bsort(void * arr,int num , int size,int(*compare_elm)(const void*, const void*)){
...
int main(){
  ...
  const char* str_arr[] = {"gravity", "diamond", "apple", "horizon", "flame", "kernel", "complex", "jungle", "eclipse", "bridge"};
