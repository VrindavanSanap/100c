 ...
 *   so as to grok the concepts so that we can later generalize this concept over to
 *   n-dimensional matrices and matrices which require a permutation matrix to be
 *   decomposed into LU.
 */
